...
<body>
 ...
 <div class="header" id="topheader">
  ...
  <a class="navbar-brand font-weight-bold text-white" href="#">NeoInfotech</a>
...
<section class="header-section">
	<div class="center-div">
		...
		<p>We create website for future. </p>
	...
	<div class="container">
		<div class="row">
			<div class=" extra-div col-lg-4 col-md-4 col-12">
				...
				<h2>EASY TO USE</h2>
				<p>hiw asnaidsajdoihsdnasdhshd nsadjasdjhsad jdkajbs</p>
			</div>
...
<section class="serviceoffers" id="servicediv">
	<div class="container headings text-center">
		...
		<p class="text-center">hello guys welcome back my youtube channel.</p>
	</div>
			...
			<div class="col-lg-6 col-md-12 col-12 servicediv">
				<div class="row">
					...
					<div class="col-lg-10 col-10">
						...
						<p>hiawdihiwhaid jsiadisaid nwlidnasdn iisdha nisandi</p>
					</div>
				</div>
...
<section class="project-work">
	<div class="container headings text-center">
		<p class="text-center font-weight-bold"> MORE THAN 50 WEBSITES CREATED</p>
    ...
    <div class="carousel-item active">
    	...
    	<div class="row">
    		<div class="col-lg-4 col-md-4 col-12">
    			<div class="box">
    				<a href="#"><img src="images/background.jpg" alt="background" class="img-fluid img-thumbnail"></a>

    				<p class="m-4">h asifsahfihaoshof sfoagsfugsugaf sadhosdhua saihdoahsdo sadhasihdoiahsd sahdihsa</p>
      ...
      <div class="col-lg-8 col-md-8 col-10 offset-lg-2 offset-md-2 offset-1">
        ...
        <form action="process.php" method="post">
            <div class="form-group">
              <input type="text" name="username" class="form-control" placeholder="Enter Your Name" id="username" required autocomplete="off">
            </div>

            <div class="form-group">
              <input type="email" name="email" class="form-control" placeholder="Enter email" id="email" required autocomplete="off">
            </div>

            <div class="form-group">
              <input type="text" name="mobile" class="form-control" placeholder="Enter Mobile Number" id="mobile" required autocomplete="off">
            </div>

            <div class="form-group">
              <textarea class="form-control" name="msg" placeholder="Enter Your Message" rows="4" id="comment"></textarea>
            </div>  
            
            <div class="d-flex justify-content-center form-button">
            <button type="submit" class="btn btn-primary" name="btn-send">Submit</button>
            </div>
        </form>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-12 footer-div">
        <div>
        <h3>ABOUT WEBSITE</h3>
        <p>nsadas hauhduahsiud iasjdoijsd</p>
        </div>
      </div>
